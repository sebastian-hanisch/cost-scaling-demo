...
def scale_costs(net, k):
    """Dasselbe Netz mit allen Kosten mal k (Kapazitäten unverändert) - die Kostenspanne wächst, die Struktur bleibt."""
    return Net(net.names, net.labels, net.pos, tuple((u, v, c, cost * k, kind) for u, v, c, cost, kind in net.arcs), net.s, net.t, net.logistic)
